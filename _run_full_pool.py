...
with open('strategies/rule/恐慌错杀-狙击_r6.yaml') as f:
...
d = r.__dict__
print(f'R6全量: EV={d["expected_value"]:.2f}% Win={d["win_rate"]:.1f}% Trade={d["total_trades"]} Time={t:.0f}s', flush=True)
...
}, open('results/恐慌错杀-狙击_r6_全量.json', 'w'), default=str)
